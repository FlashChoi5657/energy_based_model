...
from utils import UNet_Energy_log, to_numpy, init_weights, Self_Energy_log, get_dataloaders, SGLD
...
energy = Discriminator(args.in_channel, args.dim_feature, activation='swish')
