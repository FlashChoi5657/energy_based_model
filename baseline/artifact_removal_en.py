...
from utils import gaussian_noise, calculate_norm, to_numpy, SampleBuffer

# ======================================================================
# Input arguments
# ======================================================================
parser = argparse.ArgumentParser()
parser.add_argument("--name", type=str, default='31m')
...
for i in range(number_epoch):
  ...
  if i % args.save_plot == 0:
    energy.eval()
    fig, ax = plt.subplots(3, 10, figsize = (3 * 15, 3 * 10))
    for k in range(10):
