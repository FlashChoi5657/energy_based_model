...
class autoencoders(nn.Module):
    def __init__(self):
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(128, 128, kernel_size=3, output_padding=1, padding=1, stride=2),
            nn.ReLU(),
            nn.ConvTranspose2d(128, 64, kernel_size=3, output_padding=1, padding=1, stride=2),
            nn.ReLU(),
            nn.ConvTranspose2d(64, 32, kernel_size=3, output_padding=1, padding=1, stride=2),
            nn.ReLU(),
...
class Resneten(nn.Module):
    def __init__(self, n_class=None):
        super().__init__()

        self.conv1 = spectral_n(nn.Conv2d(3, 128, 3, padding=1), std=1)
